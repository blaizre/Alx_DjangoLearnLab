...
SECRET_KEY = 'django-insecure-y*^upe7f(s1s45x2(m9k=)&f@u!aqrv!fr6-on64ho+i(8c=!i'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Require auth for all API views by default
    ]
}
